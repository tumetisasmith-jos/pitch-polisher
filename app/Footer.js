...
export default function Footer() {
  return (
    <footer style={{ marginTop: 'auto', borderTop: '1px solid var(--border-subtle)', background: 'rgba(10, 11, 26, 0.4)', padding: '4rem 0 2rem 0' }}>
      <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '3rem', marginBottom: '3rem' }}>
        ...
        <div>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            ...
            <li><Link href="/" className="footer-link">Reviews</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            ...
            <li><Link href="/" className="footer-link">Pitch Templates</Link></li>
            <li><Link href="/" className="footer-link">Investor Database</Link></li>
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: '1rem' }}>
            <a href="https://github.com/tumetisasmith-jos/pitch-polisher" target="_blank" rel="noopener noreferrer" className="footer-social-link">
      ...
      <div className="container" style={{ borderTop: '1px solid var(--border-subtle)', paddingTop: '2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.85rem', flexWrap: 'wrap', gap: '1rem' }}>
